...
import sys
from qpymenu import pyMenu, pyMenuItem, hello_world, read_text_file, about, count_down
...
file_menu = pyMenu("File",  hotkey='F')
...
mi3.add_item(mi4)
mi4.add_item(pyMenuItem("Countdown", action=count_down, hotkey='X'))
